...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`director` (`id`, `first_name`, `last_name`, `gender`, `birthdate`)
VALUES (1, 'George', 'Lucas', 'Male', '1944-05-14'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`genre` (`id`, `type`)
VALUES (1, 'action'),
       (2, 'biography'),
       (3, 'comedy'),
       (4, 'adventure'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`ranking` (`id`, `rating`, `number_of_user_rates`, `metascore`, `number_of_critic_rates`)
VALUES (1, 8, 1350936, 90, 475),
       (2, 8, 958087, 85, 238),
       (3, 9, 1788532, 74, 635),
       (4, 7, 214442, 83, 411),
       (5, 6, 1212445, 67, 543),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`movie` (`id`, `genre_id`, `ranking_id`, `directors_id`, `name`, `description`, `budget`, `year`,
                              `facts`)
VALUES (1, 7, 1, 1, 'Star Wars',
       ...
       (2, 4, 2, 8, 'Raiders of the Lost Ark',
       ...
       (6, 3, 6, 5, 'The Wolf of Wall Street',
       ...
       (7, 2, 7, 6, 'A Beautiful Mind',
        'After John Nash, a brilliant but asocial mathematician, accepts secret work in cryptography, his life takes a turn for the nightmarish.',
        58000000, 2001, 'There is no \"ceremony of the pens\" at Princeton University.'),
       (8, 4, 8, 8, 'Jurassic Park',
        'A pragmatic paleontologist touring an almost complete theme park on an island in Central America is tasked with protecting a couple of kids after a power failure causes the park\'s cloned dinosaurs to run loose.',
        63000000, 1993,
        'When they arrive at the T. rex cage right before the black out, we can clearly see the ground inside the cage is approximately flush with that outside the cage. But when the T. rex escapes and begins to terrorize the two trucks, the ground in the cage is shown to be at least 100 feet below where it was before.'),
       (9, 1, 9, 7, 'The Terminator',
        'A human soldier is sent from 2029 to 1984 to stop an almost indestructible cyborg killing machine, sent from the same year, which has been programmed to execute a young woman whose unborn son is the key to humanity\'s future salvation.',
        6400000, 1984,
        'Newton\'s Third Law establishes that bullets and shotgun blasts do not have the momentum to knock a human body backwards, although the trauma of being shot may cause them to fall backward.'),
       (10, 2, 10, 6, 'Rush', 'The merciless 1970s rivalry between Formula One rivals James Hunt and Niki Lauda.',
        38000000, 2013,
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`role` (`id`, `movie_id`, `role`)
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`actor` (`id`, `roles_id`, `first_name`, `last_name`, `gender`, `birthdate`)
VALUES (1, 1, 'Mark', 'Hamill', 'Male', '1951-09-25'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`award` (`id`, `movie_id`, `name`, `year`)
VALUES (1, 4, 'Saturn Award', 2012),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`company` (`id`, `movie_id`, `name`)
VALUES (1, 1, 'Lucasfilm'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`critic_review` (`id`, `ranking_id`, `first_name`, `last_name`, `rate`, `message`)
VALUES (1, 1, 'Jack', 'Herment', 87, 'Good'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`nomination` (`id`, `award_id`, `type`)
VALUES (1, 1, 'Best DVD Collection'),
...
-- -----------------------------------------------------
INSERT INTO `teliuk`.`user_review` (`id`, `ranking_id`, `rate`, `message`, `username`, `posted_at`)
VALUES (1, 1, 8, 'Great film', 'Yukee', '2018-12-25 23:39:12'),
