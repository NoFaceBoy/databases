-- -----------------------------------------------------
-- Data for table `my_library`.`director`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`director` (`id`, `first_name`, `last_name`, `gender`, `birthdate`)
VALUES
...
-- -----------------------------------------------------
-- Data for table `my_library`.`genre`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`genre` (`id`, `type`)
VALUES
    (1, 'action'),
    (2, 'biography'),
    (3, 'comedy'),
    ...
    (10, 'detective');
-- -----------------------------------------------------
-- Data for table `my_library`.`company`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`company` (`id`, `name`)
VALUES
    (1, 'Lucasfilm'),
...
-- -----------------------------------------------------
-- Data for table `my_library`.`movie`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`movie` (`id`, `genre_id`, `ranking_id`, `company_id`, `directors_id`, `name`, `description`, `budget`, `year`, `facts`)
VALUES
...
-- -----------------------------------------------------
-- Data for table `my_library`.`role`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`role` (`id`, `movie_id`, `name`)
VALUES
    (1, 1, 'Luke Skywalker'),
    (2, 1, 'Han Solo'),
    (3, 1, 'Darth Vader'),
    ...
    (10, 9, 'Kyle Reese');
-- -----------------------------------------------------
-- Data for table `my_library`.`actor`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`actor` (`id`, `roles_id`, `first_name`, `last_name`, `gender`, `birthdate`)
VALUES
...
-- -----------------------------------------------------
-- Data for table `my_library`.`award`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`award` (`id`, `name`)
VALUES
    (1, 'Saturn Award'),
...
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`award_movie` (`award_id`, `movie_id`)
VALUES
    (1, 1),
    (2, 1),
    (4, 1),
    ...
    (2, 3);
-- -----------------------------------------------------
-- Data for table `my_library`.`nomination`
-- -----------------------------------------------------
INSERT INTO
    `my_library`.`nomination` (`id`, `award_id`, `type`)
VALUES
